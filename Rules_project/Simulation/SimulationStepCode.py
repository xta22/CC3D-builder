...
COMPILED_SETTINGS = {'execution_semantics': 'snapshot',
 'initial_layout': {'description': 'HostCell tissue contains sparse pre-existing InterstitialSpace patches. Hyphae can '
                                   'occupy InterstitialSpace; damaged host cells keep tissue-like mechanics until '
                                   'final conversion.',
                    'regions': [{'type': 'HostCell',
                                 'box_min': {'x': 18, 'y': 34, 'z': 0},
                                 'box_max': {'x': 126, 'y': 222, 'z': 1},
                                 'gap': 0,
                                 'width': 12},
                                {'type': 'FungusYeast',
                                 'box_min': {'x': 142, 'y': 132, 'z': 0},
                                 'box_max': {'x': 148, 'y': 138, 'z': 1},
                                 'gap': 0,
                                 'width': 8}],
                    'interstitial_patches': [{'x0': 48, 'y0': 72, 'x1': 55, 'y1': 80, 'width': 6},
                                             {'x0': 68, 'y0': 118, 'x1': 75, 'y1': 126, 'width': 6},
                                             {'x0': 92, 'y0': 154, 'x1': 100, 'y1': 163, 'width': 7},
                                             {'x0': 108, 'y0': 92, 'x1': 116, 'y1': 101, 'width': 7},
                                             {'x0': 42, 'y0': 184, 'x1': 50, 'y1': 193, 'width': 7},
                                             {'x0': 82, 'y0': 202, 'x1': 90, 'y1': 211, 'width': 7},
                                             {'x0': 58, 'y0': 146, 'x1': 65, 'y1': 154, 'width': 6},
                                             {'x0': 104, 'y0': 178, 'x1': 113, 'y1': 187, 'width': 7}]},
 'contact_overrides': [{'type1': 'FungusYeast', 'type2': 'FungusYeast', 'energy': 28.0},
                       {'type1': 'FungusYeast', 'type2': 'Medium', 'energy': 12.0},
                       {'type1': 'AttachedFungus', 'type2': 'AttachedFungus', 'energy': 18.0},
                       {'type1': 'AttachedFungus', 'type2': 'FungusYeast', 'energy': 22.0},
                       {'type1': 'HostCell', 'type2': 'InterstitialSpace', 'energy': 7.0},
                       {'type1': 'InterstitialSpace', 'type2': 'InterstitialSpace', 'energy': 4.0},
                       {'type1': 'InterstitialSpace', 'type2': 'Medium', 'energy': 12.0},
                       {'type1': 'HostCell', 'type2': 'FungusYeast', 'energy': 4.0},
                       {'type1': 'DamagedHostCell', 'type2': 'FungusYeast', 'energy': 4.0},
                       {'type1': 'FungusYeast', 'type2': 'InterstitialSpace', 'energy': 5.0},
                       {'type1': 'AttachedFungus', 'type2': 'HostCell', 'energy': 6.0},
                       {'type1': 'AttachedFungus', 'type2': 'DamagedHostCell', 'energy': 6.0},
                       {'type1': 'AttachedFungus', 'type2': 'InterstitialSpace', 'energy': 5.0},
                       {'type1': 'HostCell', 'type2': 'HyphaTip', 'energy': 5.0},
                       {'type1': 'DamagedHostCell', 'type2': 'HyphaTip', 'energy': 4.0},
                       {'type1': 'HyphaTip', 'type2': 'InterstitialSpace', 'energy': 2.0},
                       {'type1': 'HostCell', 'type2': 'HyphaSegment', 'energy': 6.0},
                       {'type1': 'DamagedHostCell', 'type2': 'HyphaSegment', 'energy': 5.0},
                       {'type1': 'HyphaSegment', 'type2': 'InterstitialSpace', 'energy': 2.5},
                       {'type1': 'HyphaRoot', 'type2': 'Medium', 'energy': 10.0},
                       {'type1': 'HyphaRoot', 'type2': 'HostCell', 'energy': 6.0},
                       {'type1': 'HyphaRoot', 'type2': 'DamagedHostCell', 'energy': 6.0},
                       {'type1': 'HyphaRoot', 'type2': 'InterstitialSpace', 'energy': 5.0},
                       {'type1': 'HyphaRoot', 'type2': 'AttachedFungus', 'energy': 6.0},
                       {'type1': 'HyphaRoot', 'type2': 'FungusYeast', 'energy': 10.0},
                       {'type1': 'HyphaRoot', 'type2': 'HyphaTip', 'energy': 8.0},
                       {'type1': 'HyphaRoot', 'type2': 'HyphaSegment', 'energy': 8.0},
                       {'type1': 'HyphaRoot', 'type2': 'HyphaRoot', 'energy': 10.0},
                       {'type1': 'DamagedHostCell', 'type2': 'InterstitialSpace', 'energy': 7.0},
                       {'type1': 'HostCell', 'type2': 'DamagedHostCell', 'energy': 10.0},
                       {'type1': 'DamagedHostCell', 'type2': 'DamagedHostCell', 'energy': 10.0},
                       {'type1': 'DamagedHostCell', 'type2': 'Medium', 'energy': 10.0}],
 'connectivity': {'enabled': True,
                  'plugin': 'ConnectivityGlobal',
                  'fast_algorithm': True,
                  'cell_types': ['FungusYeast', 'AttachedFungus', 'HyphaRoot', 'HyphaSegment', 'HyphaTip']}}
COMPILED_CELLTYPE_PARAMS = {'HostCell': {'targetVolume': 160.0, 'lambdaVolume': 1.5, 'should_initialize': True, 'initial_count': 135},
 'FungusYeast': {'targetVolume': 18.0, 'lambdaVolume': 8.0, 'should_initialize': True, 'initial_count': 1},
 'AttachedFungus': {'targetVolume': 18.0, 'lambdaVolume': 18.0, 'should_initialize': False, 'initial_count': 0},
 ...
 'InterstitialSpace': {'targetVolume': 8.0, 'lambdaVolume': 10.0, 'should_initialize': True, 'initial_count': 8},

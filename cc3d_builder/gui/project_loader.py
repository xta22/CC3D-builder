...
class ProjectLoader(QWidget):
    ...
    def load_project(self):
        ...
        profile_exists = has_project_profile(source_path)
        is_import = False
        ...
        if json_exists or profile_exists:
            ...
            btn_import = msg.addButton("Import New (Clear Project Rules)", QMessageBox.ActionRole)
            resume_label = "Resume Project Rules" if profile_exists else "Resume Current Sandbox Rules"
            btn_resume = msg.addButton(resume_label, QMessageBox.ActionRole)
